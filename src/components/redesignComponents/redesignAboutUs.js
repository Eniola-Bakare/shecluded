    ...
    <div>
      <div className="about-page-wrapper">
        ...
        <div className="about-content">
          ...
          <div className="about-hero-section row d-flex flex-md-row flex-column">
            <div className="about-hero-text col-md-6 col-12 d-flex flex-column">
              <p className='about-us'>ABOUT US</p>
              <h1 className="about-hero">We Hold Your Hands To <span>Finance Your Future</span></h1>
            ...
            <div className="about-hero-image col-md-6 col-6">
              <img src={require ('../../assets/newRedesign-assets/about-hero.png')} alt="image of a woman" />
            </div>
          </div>

          <div className="about-services row d-flex flex-md-row flex-column p-5 m-0">
            <div className="about-servies-para what-we-do col-12 col-md-4 p-3 mt-5 mb-5">
            ...
            <div className="about-servies-para who-we-serve col-12 col-md-4 p-3 mt-5 mb-5">
            ...
            <div className="about-servies-para what-we-believe col-12 col-md-4 p-3 mt-5 mb-5">
          ...
          <div className="about-note">
            <p className="about-para">What started as a little white reader is now a powerful ecosystem of commerce solutions.</p>
          </div>

          <div className="about-figures">
            <p className="about-figures-title">Today Our Work Is More. Important And Impactful Than Ever</p>
            <div className="about-figures-sub">
              <div className="about-figures-img-div">
                <img src={require ('../../assets/newRedesign-assets/about-figures.png')} alt="image of a woman" />
              </div>

              <div className="about-figures-number-div">
                <div className="about-figures-number-div-desc">
