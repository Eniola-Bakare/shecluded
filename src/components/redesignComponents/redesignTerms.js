...
const redesignTerms = () => {
	...
	const cookiesScroll = () => {
		 cookies.current.scrollIntoView()
	}

	const privacyScroll = () => {
		privacy.current.scrollIntoView()
 }
 const riskScroll = () => {
	risk.current.scrollIntoView()
}
        ...
        <div className="terms-wrapper d-flex flex-column justify-content-center mx-auto">
            <div  className="terms-header d-flex flex-column align-items-center">
                ...
                <div  className="mb-5 terms-header-content d-flex flex-column align-items-center">
                    ...
                    <div className="tab-container px-2 py-0 px-md-2 py-md-3 d-flex justify-content-around align-items-center">
                       <button id='1' className='tab-links' onClick={privacyScroll} >Privacy Policy</button>
                      
                      <div className="divider"></div>
                      <button id='2' className='tab-links' onClick={riskScroll}>Risk Disclosure Notice</button>
                      
                      <div className="divider"></div>
                      <button onClick={cookiesScroll} id='3' className='tab-links'>Cookie Policy</button>
            ...
            <div className="terms-body mx-auto">
              <h5 ref={privacy} id='privacy'>The following information is to help you understand how we collect, use, disseminate and safeguard the data you provide while accessing and using Nigerian Mockups.<br></br>
              ...
              <h5 ref={risk} id='risk-disclosure'>Personal Information We Collect</h5>
              <br></br>
              <br></br>
              ...
              <h5 ref={cookies} id='cookies'>Cookies</h5>
              <br></br>
              <br></br>
