...
class Equipment extends Component {
    ...
    super(props);
    this.state = {
			loanData: {dailyInterest: 0.004, durationType: "monthly", duration: 6, costOfEquipment: 0, estimatedMonthlyRevenue: 0, estimatedServiceYears: 0},
			calculate: "Calculate",
			duration: 6,
			isHidden: "true",
			maxDurationValue: 12
	...
	toggleHidden () {
		...
		if (this.state.calculate === "Reset Calculator"){
			loanData.costOfEquipment = 0;
			loanData.estimatedMonthlyRevenue = 0;
			loanData.estimatedServiceYears = 0;
			loanData.duration = 6;
		}
		this.setState({
	...
	calculateLoanAmount()
	{
		return this.state.loanData.costOfEquipment;
	}
	...
	calculateRevenue()
	{
		return this.state.loanData.estimatedMonthlyRevenue * this.state.loanData.estimatedServiceYears * 12
	}
	...
	render()
	{
		...
		const enabled = loanData.costOfEquipment > 0 && loanData.estimatedMonthlyRevenue > 0 && loanData.estimatedServiceYears > 0;
				...
				<div className="roi-calculator-holder">
					...
					<div className="form-row justify-content-aroundX p-3">
						<div className="form-group col-12 col-md-6">
							<h6 className="text-body"> Cost of new equipment </h6>
							<div className="d-flex align-items-center">
								<label className="pr-2"> &#8358; </label>
								<input className="form-control" name="costOfEquipment" type="number" placeholder="e.g. 100000" value={loanData.costOfEquipment} onChange={this.handleChange}/>

							</div>
						</div>

						<div className="form-group col-12 col-md-6">
							<h6 className="text-body ">Estimated monthly revenue</h6>
							<div className="d-flex align-items-center">
								<label className="pr-2"> &#8358; </label>
								<input className="form-control" name="estimatedMonthlyRevenue" type="number" placeholder="e.g. 100000" value={loanData.estimatedMonthlyRevenue} onChange={this.handleChange}/>
					...
					<div className="form-row justify-content-around p-3">
						<div className="form-group col-12 col-md-6">
							<h6 className="text-body ">Estimated years in service</h6>
							<div className="d-flex align-items-center">
								<input className="form-control" name="estimatedServiceYears" type="number" placeholder="e.g. 100000" value={loanData.estimatedServiceYears} onChange={this.handleChange} />
...
const Child = (props) => (
	...
	<h2 className="mt-5">Equipment ROI Result</h2>
	</div>
	<hr/>
